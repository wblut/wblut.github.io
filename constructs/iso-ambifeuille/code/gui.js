function addLegend() {
    ...
    for (let l = 0; l < NUMLAYERS; l++) {
        ...
        legendX[l] = isoX(0, 0, 6 * zoom, I - 1 + padding, 7 * l + padding / 2 - 18, -padding);
        legendY[l] = isoY(0, 0, 6 * zoom, I - 1 + padding, 7 * l + padding / 2 - 18, -padding);
    }
    for (let i = 0; i < 3; i += 2) {
        for (let k = 0; k < 3; k += 2) {
...
function addControls() {
    ...
    let dl = padding / 2;
    for (let l = 0; l < 8; l++) {
        controlX[l] = isoX(0, 0, 6 * zoom, -padding, dl - 18, K - 1 + padding);
        controlY[l] = isoY(0, 0, 6 * zoom, -padding, dl - 18, K - 1 + padding);
        dl += (l === 0) ? 8 : 7;
    }
    dl = padding / 2;
    let l = 0;
...
function addMotion() {
    ...
    motionX[l] = isoX(0, 0, 6 * zoom, -padding, dl - 18, K - 1 + padding);
    motionY[l] = isoY(0, 0, 6 * zoom, -padding, dl - 18, K - 1 + padding);
    l = 1;
    dl += 7;
    for (let i = 0; i < 3; i++) {
        for (let k = 0; k < 3; k++) {
    ...
    motionX[l] = isoX(0, 0, 6 * zoom, -padding + 1, dl - 18, K - 1 + padding);
    motionY[l] = isoY(0, 0, 6 * zoom, -padding + 1, dl - 18, K - 1 + padding);
    l = 2;
    dl += 7;
    for (let i = 0; i < 3; i++) {
        for (let k = 0; k < 3; k++) {
    ...
    motionX[l] = isoX(0, 0, 6 * zoom, -padding, J + padding - 18, K + 1);
    motionY[l] = isoY(0, 0, 6 * zoom, -padding, J + padding - 18, K + 1);
    l = 7;
    for (let i = 0; i < 3; i++) {
        for (let k = 0; k < 3; k++) {
            for (let j = 0; j < 3; j++) {
    ...
    motionX[l] = isoX(0, 0, 6 * zoom, -padding, J + padding - 18, K - 5);
    motionY[l] = isoY(0, 0, 6 * zoom, -padding, J + padding - 18, K - 5);
}
