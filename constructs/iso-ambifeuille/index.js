...
function initGeneratorParameters() {
    ...
    blockLayer = hl.random(0.22, 0.34);
}
...
function createAmbifeuille() {
    ...
    mainDrawingGrid.centerOn(0, 18, 0);
    frameGrid = new TriangleGrid(0, 0, zoom * 6.0);
    frameGrid.centerOn(0, 18, 0);
    prepare();
}
...
function draw() {
    ...
    drawScale = min(windowWidth / 1000.0, windowHeight / 1300.0);
    scale(drawScale);
